...
namespace PanzerAdmiral.ScreenSystem
{
    ...
    {
        private static AssetCreator _assetCreator;
        private static ContentManager _contentManager;

        private static InputHelper _input;
        private bool _isInitialized;
        private static LineBatch _lineBatch;
        ...
        /// <summary> Contains all the fonts avaliable for use. </summary>
        ...
        public static AssetCreator Assets
        {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            PanzerAdmiral.Sounds.Sound.Update();
