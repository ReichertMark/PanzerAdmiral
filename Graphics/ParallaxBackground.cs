...
namespace PanzerAdmiral.Graphics
{
    ...
    /// <summary> Moving Background Layers for GameScreens. </summary>
    public class ParallaxBackground
    {
        #region Variables
        private float _speedX = 1;
        /// <summary> Gets or sets the speed X. </summary>
        public float SpeedX
        {
            get { return _speedX; }
            set { _speedX = value; }
        ...
        /// <summary> Gets or sets the speed Y. </summary>
        public float SpeedY
        {
            get { return _speedY; }
            set { _speedY = value; }
        ...
        /// <summary> Moves by default speed and distance. </summary>
        public void Move()
        {
